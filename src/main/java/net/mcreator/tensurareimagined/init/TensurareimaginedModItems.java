...
public class TensurareimaginedModItems {
	...
	public static final RegistryObject<Item> SHLIME_SPAWN_EGG = REGISTRY.register("shlime_spawn_egg", () -> new ForgeSpawnEggItem(TensurareimaginedModEntities.SHLIME, -16724737, -10027009, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
