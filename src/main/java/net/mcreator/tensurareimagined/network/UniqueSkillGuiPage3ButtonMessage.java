...
public class UniqueSkillGuiPage3ButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TensurareimaginedMod.addNetworkMessage(UniqueSkillGuiPage3ButtonMessage.class, UniqueSkillGuiPage3ButtonMessage::buffer,
				UniqueSkillGuiPage3ButtonMessage::new, UniqueSkillGuiPage3ButtonMessage::handler);
	}
}
