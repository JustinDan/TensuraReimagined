...
public class ReincarnationOrcGuiButtonMessage {
	private final int buttonID, x, y, z;

	public ReincarnationOrcGuiButtonMessage(FriendlyByteBuf buffer) {
	...
	public ReincarnationOrcGuiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(ReincarnationOrcGuiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(ReincarnationOrcGuiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = ReincarnationOrcGuiMenu.guistate;
