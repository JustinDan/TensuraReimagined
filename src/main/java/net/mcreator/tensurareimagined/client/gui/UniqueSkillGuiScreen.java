...
public class UniqueSkillGuiScreen extends AbstractContainerScreen<UniqueSkillGuiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Unique Skills", 10, 6, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 10, this.topPos + 23, 61, 20, Component.literal("Severer"), e -> {
			if (true) {
