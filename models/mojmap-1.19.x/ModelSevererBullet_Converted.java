...
public class ModelSevererBullet_Converted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "severerbullet_converted"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition group = partdefinition.addOrReplaceChild("group", CubeListBuilder.create().texOffs(0, 0)
				.addBox(7.0F, -1.4F, -12.7F, 1.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-8.0F, 12.0F, 7.0F));

		PartDefinition cube_r1 = group
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 0).addBox(7.0F, 8.0F, -10.0F, 1.0F, 2.0F, 2.0F,
